...
const LocationDetail = ({ locations, onUpdate, onDelete }: { 
  ...
  useEffect(() => {
    if (!foundLocation && id) {
       // Logic for direct access to ID not in state (optional)
    }
  }, [id, foundLocation]);
        ...
        <div className="lg:col-span-5 space-y-8">
          ...
          <Card className="space-y-6">
            <div className="flex items-center justify-between">
               ...
               <button className="text-xs font-black text-primary-950 uppercase tracking-widest hover:underline decoration-2">Upload Baru</button>
            </div>
            <div className="aspect-video bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-300 group cursor-pointer hover:border-primary-950 transition-colors">
            ...
            <div className="p-6 bg-slate-50/50 border-t border-slate-100 grid grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs font-bold text-slate-700">Tinggi (Precise)</p>
                </div>
              </div>
              <div className="space-y-1">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Google Drive Sync</p>
                <div className="flex items-center gap-2">
                  <Badge variant="info" className="!px-2 !py-0.5">READY</Badge>
                </div>
              </div>
            </div>
          </Card>
